...
func (c *greeterService) Hello(ctx context.Context, in *HelloReq, opts ...client.CallOption) (*HelloRes, error) {
...
func (h *greeterHandler) Hello(ctx context.Context, in *HelloReq, out *HelloRes) error {
